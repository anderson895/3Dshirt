...
import { Stage, Layer as KLayer, Rect, Text as KText, Image as KImage, Transformer, Group, Line } from 'react-konva'
...
const PartCanvas = forwardRef<PartCanvasHandle, Props>(({ part, onDirty, showGrid = true, showSafe = true }, ref) => {
  ...
  return (
    <div className="border rounded overflow-hidden bg-white">
      ...
      <Stage
        ...
        ref={stageRef}
        onWheel={wheelZoom}
        onMouseDown={(e) => { if (!editingEnabled) return; if (e.target === e.target.getStage()) setSelectedId(null) }}
        onTouchStart={(e) => { if (!editingEnabled) return; if (e.target === e.target.getStage()) setSelectedId(null) }}
        className="bg-white"
